 ...
 * @returns {Promise<object>} The evaluation result { keyphraseResults, coveragePercent }
 */
...
"${candidateTranscript}"`;
  ...
  const coveragePercent = total > 0 ? ((hits + 0.5 * partials) / total) * 100 : 0;
